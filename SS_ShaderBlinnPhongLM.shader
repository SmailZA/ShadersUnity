Shader "Custom/SS_ShaderBlinnPhongLM"
{
    Properties
    {
        _MainTex("Texture", 2D) = "white" {}
		_MainTint("Tints Color", Color) = (1,1,1,1)
		_SpecularColor("Speculars Color", Color) = (1,1,1,1)
		_SpecPower("The Specular Power", Range(0, 30)) = 1
    }
    SubShader
    {
